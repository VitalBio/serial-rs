...
impl io::Read for TTYPort {
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
        ...
        let len =
            unsafe { libc::read(self.fd, buf.as_ptr() as *mut c_void, buf.len() as size_t) };
...
impl io::Write for TTYPort {
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
        ...
        let len =
            unsafe { libc::write(self.fd, buf.as_ptr() as *mut c_void, buf.len() as size_t) };
...
impl SerialPortSettings for TTYSettings {
    fn baud_rate(&self) -> Option<core::BaudRate> {
        ...
        use termios::{
            B110, B1200, B134, B150, B1800, B19200, B200, B2400, B300, B38400, B4800, B50,
            B600, B75, B9600,
        };
